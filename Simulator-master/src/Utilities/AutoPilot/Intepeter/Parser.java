...
public class Parser {
    ...
    private final Deque<Symbol> scopes;
    private final ConcurrentHashMap<String, Double> bindVarValueMap;
    private HashMap<String, Function> globalFuncitonMap;
    public MyInterpreter myInterpreter;
    public HashMap<String, Command> getCommandMap() {
        return commandMap;
    }
    public Symbol getLastScope() {
        return scopes.getLast();
    }
    public Symbol addScope() {
        scopes.addLast(new Symbol());
        return scopes.getLast();
    }
...
//                    removeLastScope();
    ...
    public double parse(String codeStr, MyInterpreter interpreter) throws CodeErrorException {
